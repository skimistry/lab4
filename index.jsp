...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="container theme-showcase" role="main">
		...
		<div class="jumbotron">
			<h1>Book Library!</h1>
			<p>Welcome to BookLib!</p>
			<p>
				<a class="btn btn-primary btn-lg" role="button" href="MyJsp.action">Start Searching books</a>
			</p>
			<br /><br />
			<b>If you want to delete a book, search it first, and delete.</b>
		</div>
	</div>
