...
<body>
	...
	<div class="container theme-showcase" role="main">
		<br /> <br /> <br /> <br />
		<center>
		<h1>Select a way to search book:</h1>
		
				<a href="searchByBook.action"><b>Search By Book</b> </a> <br> <a
				href="searchByName.action"><b>Search By Author</b> </a> <br>
				<hr>
			<!--<s:form action="returnMyJsp.action">
				<s:submit class="btn btn-default" value="Return" />
			</s:form>-->
		</center>
	</div>
